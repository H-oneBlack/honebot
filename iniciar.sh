...
Por favor espere o boot está sendo instalado pode demorar um pouco, aguarde..."
...
wget https://github.com/H-oneBlack/honebot/raw/master/%40admysshbot.zip -O bot.zip && unzip bot.zip > /dev/null
